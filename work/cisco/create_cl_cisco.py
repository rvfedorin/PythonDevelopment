...
class CiscoCreate:
    def __init__(self, _my_key, _my_key_e, _p_un_sup, city):
...
if __name__ == '__main__':
    ...
    _cisco = CiscoCreate('', '', '', 'Bel')
    _cisco.city_shelve = os.path.abspath('../data/city.shelve')
    print(_cisco.get_free_interface())
